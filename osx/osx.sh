...
## Do not Restart automatically if the computer freezes
...
## Save screenshots to the desktop/Screen\ Captures
#defaults write com.apple.screencapture location -string "${HOME}/Desktop/“Screen\ Captures
...
## Security settings                                                           #
################################################################################
##Allow apps downloaded from "anywhere", not just mac app store and idenitifed developers
...
## Move the Dock to the left-hand side
