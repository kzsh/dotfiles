...
function getInfoPlistTemplate() {
  ...
  local application_executable
  local application_name

  application_executable="$(basename "$application")"
  application_name="$(echo "$application_executable" | cut -d '.' -f1)"
...
function getDocumentWorkflowTemplate() {
  local service_file_path="$1"
  local application="$2"

  local bundle_id
  bundle_id=$(getBundleId "$application")
cat << EOF
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
	...
	<array>
		<dict>
			...
			<dict>
				...
				<dict>
					<key>COMMAND_STRING</key>
					<string>osascript -l JavaScript "${service_file_path}"</string>
					<key>CheckedForUserDefaultShell</key>
					<true/>
					<key>inputMethod</key>
					<integer>0</integer>
				...
				<key>InputUUID</key>
				<string>6074F36C-98AD-4AC6-9CA7-05D7AB686FF7</string>
				<key>Keywords</key>
				<array>
					<string>Shell</string>
				...
				<key>OutputUUID</key>
				<string>BF5EBD5A-3805-4576-8C89-4595F2AFAE84</string>
				<key>UUID</key>
				<string>8BDB88DF-A0F2-441C-9B0A-E9FBF75C4B20</string>
